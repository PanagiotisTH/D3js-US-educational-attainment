...
//    .range(["#513ac4", "#271487", "#331bad", "#3d22c1", "#4320ea", "#31217c", "#4430a5"]);
//    .range(["#a7c94a", "#7ca019", "#8fbc14", "#aedb34", "#8bad2e", "#a5c942", "#c5ed5a"]);
//.range(["#dd8b54", "#bf6122", "#8e4d22", "#91400b", "#dd6a1f", "#ea7e38", "#b75f26"]);
//.range(["#e84e4e", "#7f0f0f", "#ce2727", "#e84040", "#d34a4a", "#8e3737", "#ea1212"]);
.range(["#513ac4", "#271487", "#3d22c1", "#a7c94a", "#dd8b54", "#bf6122", "#e84e4e"]);
